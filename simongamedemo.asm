...
select_black:
	sub R3,R3,R3
	jmp draw_color_loop ;; mozes nekako zapamtiti zadnju nacrtanu boju i staviti njene diodice na black ili mozes jednostavno citav 8x8 staviti na black
...
draw_color_loop:
	...
	jmp draw_color_loop
draw_color_end:
	inc R3,R3 ;; Sledeca boja (TEST PRIVREMENO, OBRISI ME)
